...
const ProgressFor2022 = (): JSX.Element => (
    <>
        ...
        <Container>
            ...
            <p><em>Last Updated: September 29, 2022</em></p>

            <h2>Goal #1: Running and Biking More</h2>
            <p>My goal for 2022 is 400 miles running and 500 miles biking.</p>

            <h3>Running</h3>
            <ProgressBar color="hsl(240, 74%, 52%)" fullValue={400} currentValue={351.22} />
            ...
            <ProgressBar color="hsl(315, 88%, 51%)" fullValue={26500} currentValue={18980} format="money" />
            ...
            <ProgressBar color="hsl(64, 85%, 35%)" fullValue={20500} currentValue={12980} format="money" />
            ...
            <ProgressBar color="hsl(271, 88%, 51%)" fullValue={30} currentValue={15} />

            <h3>Non-Fiction Books Read</h3>
            <ProgressBar color="hsl(93, 87%, 39%)" fullValue={15} currentValue={11} />
            ...
            <ProgressBar color="hsl(24, 69%, 59%)" fullValue={10} currentValue={4} />
        </Container>
    </>
);
