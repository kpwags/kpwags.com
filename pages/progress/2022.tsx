...
const ProgressFor2022 = (): JSX.Element => (
    <>
        ...
        <Container>
            ...
            <p><em>Last Updated: April 4, 2022</em></p>

            <h2>Goal #1: Running and Biking More</h2>
            <p>My goal for 2022 is 400 miles running and 500 miles biking.</p>

            <h3>Running</h3>
            <ProgressBar color="hsl(240, 74%, 52%)" fullValue={400} currentValue={112.81} />
            ...
            <h3>Deadlift Max</h3>
            <ProgressBar color="hsl(150, 96%, 29%)" fullValue={400} currentValue={375} />

            <h3>Squat Max</h3>
            <ProgressBar color="hsl(19, 100%, 37%)" fullValue={350} currentValue={335} />
            ...
            <ProgressBar color="hsl(315, 88%, 51%)" fullValue={26500} currentValue={7702} format="money" />

            <h3>IRA Contributions</h3>
            <ProgressBar color="hsl(194, 88%, 51%)" fullValue={6000} currentValue={3500} format="money" />

            <h3>401k Contributions</h3>
            <ProgressBar color="hsl(64, 85%, 35%)" fullValue={20500} currentValue={4202} format="money" />
            ...
            <ProgressBar color="hsl(271, 88%, 51%)" fullValue={30} currentValue={5} />

            <h3>Non-Fiction Books Read</h3>
            <ProgressBar color="hsl(93, 87%, 39%)" fullValue={15} currentValue={3} />
            ...
            <ProgressBar color="hsl(24, 69%, 59%)" fullValue={10} currentValue={1} />
        </Container>
    </>
);
