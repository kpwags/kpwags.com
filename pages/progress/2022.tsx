...
const ProgressFor2022 = (): JSX.Element => (
    <>
        ...
        <Container>
            ...
            <p><em>Last Updated: November 3, 2022</em></p>

            <h2>Goal #1: Running and Biking More</h2>
            <p>My goal for 2022 is 400 miles running and 500 miles biking.</p>

            <h3>Running</h3>
            <ProgressBar color="hsl(240, 74%, 52%)" fullValue={400} currentValue={357.3} />
            ...
            <ProgressBar color="hsl(315, 88%, 51%)" fullValue={26500} currentValue={21362} format="money" />
            ...
            <ProgressBar color="hsl(64, 85%, 35%)" fullValue={20500} currentValue={15362} format="money" />
            ...
            <ProgressBar color="hsl(271, 88%, 51%)" fullValue={30} currentValue={16} />

            <h3>Non-Fiction Books Read</h3>
            <ProgressBar color="hsl(93, 87%, 39%)" fullValue={15} currentValue={12} />
            ...
            <ProgressBar color="hsl(24, 69%, 59%)" fullValue={10} currentValue={5} />
        </Container>
    </>
);
