...
const ProgressFor2023 = (): JSX.Element => (
    <>
        ...
        <div className={styles.container}>
            ...
            <ProgressBar color="hsl(271, 88%, 51%)" fullValue={30} currentValue={34} />
            ...
            <ProgressBar color="hsl(150, 96%, 29%)" fullValue={1000} currentValue={1005} />
            ...
            <h3>Running</h3>
            <ProgressBar color="hsl(240, 74%, 52%)" fullValue={400} currentValue={255} />

            <h3>Biking</h3>
            <ProgressBar color="hsl(167, 100%, 37%)" fullValue={400} currentValue={25} />
