    ...
    <>
        ...
        <main>
            <div className={styles.container}>
                ...
                <p><em>Last Updated: May 11, 2022</em></p>
                ...
                <ProgressBar color="hsl(271, 88%, 51%)" fullValue={30} currentValue={10} />
                ...
                <ProgressBar color="hsl(24, 69%, 59%)" fullValue={12} currentValue={4} />
                ...
                <h3>Running</h3>
                <ProgressBar color="hsl(240, 74%, 52%)" fullValue={400} currentValue={152.47} />
