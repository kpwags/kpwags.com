...
const ProgressFor2023 = (): JSX.Element => (
    <>
        ...
        <div className={styles.container}>
            ...
            <p>My goal for 2023 teach myself guitar. Once I figure out a good metric for it, I&apos;ll place it here.</p>
            ...
            <ProgressBar color="hsl(271, 88%, 51%)" fullValue={30} currentValue={2} />
            ...
            <ProgressBar color="hsl(24, 69%, 59%)" fullValue={12} currentValue={0} />
            ...
            <ProgressBar color="hsl(150, 96%, 29%)" fullValue={1000} currentValue={830} />
            ...
            <h3>Running</h3>
            <ProgressBar color="hsl(240, 74%, 52%)" fullValue={400} currentValue={23.28} />
