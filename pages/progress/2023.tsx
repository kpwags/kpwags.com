    ...
    <>
        ...
        <main>
            <div className={styles.container}>
                ...
                <p><em>Last Updated: October 30, 2022</em></p>
                ...
                <ProgressBar color="hsl(271, 88%, 51%)" fullValue={30} currentValue={33} />
                ...
                <h3>Running</h3>
                <ProgressBar color="hsl(240, 74%, 52%)" fullValue={400} currentValue={248.04} />
