    ...
    <>
        ...
        <main>
            <div className={styles.container}>
                ...
                <p><em>Last Updated: August 11, 2022</em></p>
                ...
                <ProgressBar color="hsl(24, 69%, 59%)" fullValue={14} currentValue={6} />
                ...
                <h3>Running</h3>
                <ProgressBar color="hsl(240, 74%, 52%)" fullValue={400} currentValue={201.92} />
