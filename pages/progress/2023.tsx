...
const ProgressFor2023 = (): JSX.Element => (
    <>
        ...
        <div className={styles.container}>
            ...
            <p><em>Last Updated: January 27, 2022</em></p>
            ...
            <ProgressBar color="hsl(271, 88%, 51%)" fullValue={30} currentValue={4} />
            ...
            <ProgressBar color="hsl(150, 96%, 29%)" fullValue={1000} currentValue={880} />
            ...
            <h3>Running</h3>
            <ProgressBar color="hsl(240, 74%, 52%)" fullValue={400} currentValue={37.22} />
