...
date: '2016-09-15'
description: "Thinking about Apple's iPhone 7 announcement"
tags: [{ name: 'Technology', url: 'technology' }, { name: 'Thoughts', url: 'thoughts' }]
excerpt: 'This post is a follow-up on my previous post about the iPhone 7.'
---
...
<PostImage
    src="/images/posts/2016-09-15-thoughts-on-the-iphone-7/belkin-adapter.jpg"
    alt="Belkin iPhone adapter"
    centered
    shadowed={false}
    width={640}
    height={385}
...
<PostImage
    src="/images/posts/2016-09-15-thoughts-on-the-iphone-7/michael-scott-no.gif"
    alt="Michael Scott - NO"
    centered
    shadowed={false}
    width={240}
    height={196}
