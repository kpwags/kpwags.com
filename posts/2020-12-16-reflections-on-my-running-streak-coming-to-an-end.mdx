...
date: '2020-12-16'
description: 'This past Monday, December 14, my running streak came to an end. I managed to get it up to 175 days, almost half the year. In the end, I just felt it was time to let it go.'
tags: [{ name: 'Fitness', url: 'fitness' }, { name: 'Running', url: 'running' }]
excerpt: 'This past Monday, December 14, my running streak came to an end. I managed to get it up to 175 days, almost half the year. In the end, I just felt it was time to let it go.'
---
...
<PostImage
    src="/images/posts/2020-12-16-reflections-on-my-running-streak-coming-to-an-end/marathon-complete.jpg"
    alt="Me Finishing the 2015 Philadelphia Marathon"
    width={1920}
    height={979}
    shadowed
    centered
    credit={<>Me successfully finishing the 2015 Philadelphia Marathon</>}
/>
