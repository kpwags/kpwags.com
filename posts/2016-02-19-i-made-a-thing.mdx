...
date: '2016-02-19'
description: 'I made a quick little project.'
tags: [{ name: 'Development', url: 'development' }, { name: 'Where Do You Want to Eat?', url: 'where-do-you-want-to-eat' }]
excerpt: "So I was in a 'I want to develop something mood' recently, but didn't feel like digging into a big project, so I came up with an idea for a new project."
---
...
<PostImage
    src="/images/posts/2016-02-19-i-made-a-thing/where-do-you-want-to-eat.jpg"
    alt="Where Do You Want To Eat"
    width={1600}
    height={1000}
    centered
    shadowed
