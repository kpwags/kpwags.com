...
date: '2020-09-24'
description: "I found a nifty little tool that makes things a little easier for me so I figured I'd share."
tags: [{ name: 'Development', url: 'development' }, { name: 'Unit Testing', url: 'unit-testing' }]
excerpt: "I ended up starting a new project recently which I'll get into later, but after my experience writing unit tests with Digital Family Cookbook, I decided to write the tests as I code for this new project. I found a nifty little tool that makes things a little easier for me so I figured I'd share."
---
...
<PostImage
    src="/images/posts/2020-09-24-handy-visual-studio-code-plugin-for-jest/jestrunner.png"
    alt="Jest Runner in Action in VS Code"
    width={1998}
    height={1123}
    shadowed
    centered
