...
date: '2020-06-24'
description: 'Section 230 should remain in place to protect the internet'
tags: [{ name: 'Technology', url: 'technology' }, { name: 'Internet', url: 'internet' }, { name: 'Thoughts', url: 'thoughts' }]
excerpt: 'I’m going to preface this by saying that I am by no means an expert when it comes to all the nuances of Section 230 of the Communications Decency Act. I do however know that Section 230 serves as the underpinning of how the current Internet works and why all the sites that we all love can survive and exist.'
---
...
<PostImage
    src="/images/posts/2020-06-24-section-230-should-be-protected/xkcd_free_speech.png"
    alt="xkcd: Free Speech Comic"
    width={566}
    height={577}
    credit={
        <>
            Credit{' '}
            <a href="https://xkcd.com/1357/" title="xkcd: Free Speech Comic">
                xkcd
            </a>
        </>
    }
