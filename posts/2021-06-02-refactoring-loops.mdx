...
date: '2021-06-02'
description: "Ever feel like you can never completely get started with a project? That's sometimes how it feels with the fitness tracking app I'm building."
tags: [{ name: 'Development', url: 'development' }, { name: '.NET', url: 'dotnet' }, { name: 'React', url: 'react' }]
excerpt: "Ever feel like you can never completely get started with a project? That's sometimes how it feels with the fitness tracking app I'm building."
---
...
<PostImage src="/images/posts/2021-06-02-refactoring-loops/code.jpg" alt="Computer Code" width={2560} height={1704} centered shadowed={false} />
