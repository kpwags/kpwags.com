...
date: '2017-08-13'
description: 'Changing how I interact with social media'
tags: [{ name: 'Social Media', url: 'social-media' }, { name: 'Thoughts', url: 'thoughts' }, { name: 'News', url: 'news' }]
excerpt: 'Recently, much has changed in regards to my presence on social media.'
---
