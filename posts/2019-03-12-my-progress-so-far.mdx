...
date: '2019-03-12'
description: 'Two and a half months in, I figured I’d reflect on where things stand with regards towards working towards the goals I set for myself.'
tags: [{ name: 'Goals', url: 'goals' }, { name: 'Life', url: 'life' }, { name: 'Yearly Check-In', url: 'yearly-check-in' }]
excerpt: 'Two and a half months in, I figured I’d reflect on where things stand with regards towards working towards the goals I set for myself.'
---
