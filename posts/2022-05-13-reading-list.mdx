...
date: '2022-05-13'
tags: [{ name: 'Reading Log', url: 'reading-log' }, { name: 'Software Development', url: 'software-development' }, { name: 'Economics', url: 'economics' }, { name: 'AI', url: 'ai' }, { name: 'Work', url: 'work' }, { name: 'Video Games', url: 'video-games' }]
