...
date: '2017-09-28'
description: 'Looking at how Star Trek might be changing the way streaming works'
tags: [{ name: 'Thoughts', url: 'thoughts' }, { name: 'Media', url: 'media' }]
excerpt: 'Sunday night, like many Star Trek fans sat down to watch the premiere of Star Trek: Discovery.'
---
