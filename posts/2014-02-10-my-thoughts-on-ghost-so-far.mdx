...
date: '2014-02-10'
description: 'My thoughts on using Ghost for several weeks'
tags: [{ name: 'Development', url: 'development' }, { name: 'Blogging', url: 'blogging' }, { name: 'Thoughts', url: 'thoughts' }]
excerpt: "Two weeks ago, I decided to make the switch from WordPress to Ghost as my blogging platform. For me it was a figuratively big jump as I have been using WordPress for years and hadn't really thought of switching to any other platform."
---
