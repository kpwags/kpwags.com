...
date: '2015-11-01'
description: 'Recognizing the issues that exist within the Computer Fraud and Abuse Act'
tags: [{ name: 'Technology', url: 'technology' }, { name: 'Internet', url: internet' }, { name: 'Politics', url: 'politics' }]
excerpt: "I was listening to the Reply All podcast today and they had an interesting episode regarding the Computer Fraud and Abuse Act. I knew some basics about it, but never knew how general and open-ended it really was. It really is disturbing to me that people could be charged for simply violating the terms of service on a site like Facebook. It’s highly unlikely that the government will go after you for it, but it's still scary to know that the potential is there."
---
