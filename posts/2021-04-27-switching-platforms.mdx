...
date: '2021-04-27'
description: "I've been using Jekyll to run this blog for the better part of the last six years. But recently, I've been giving serious consideration to switching to Gatsby or Next.js."
tags: ['Development', 'Next.js', 'React', 'Blogging']
excerpt: "I've been using Jekyll to run this blog for the better part of the last six years. But recently, I've been giving serious consideration to switching to Gatsby or Next.js."
---
...
<PostImage src="/images/posts/2021-04-27-switching-platforms/nextjs.svg" alt="Next.js Logo" width={207} height={124} centered shadowed={false} />
