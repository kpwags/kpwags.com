...
date: '2015-12-17'
description: "After some false starts, I've run a marathon."
tags: [{ name: 'Goals', url: 'goals' }, { name: 'Fitness', url: 'fitness' }, { name: 'Running', url: 'running' }]
excerpt: 'I did it. I actually did it. Even almost a month later it sometimes dawns on me how amazing it is that I was able to run a full marathon (26.2 miles).'
---
...
<PostImage
    src="/images/posts/2015-12-17-i-finally-ran-a-marathon/marathon-complete.jpg"
