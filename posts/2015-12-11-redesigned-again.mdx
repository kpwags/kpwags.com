...
date: '2015-12-12'
description: 'Redesigning and changing my blogging platform to Jekyll'
tags: [{ name: 'Development', url: 'development' }, { name: 'Design', url: 'design' }, { name: 'Blogging', url: 'blogging' }]
excerpt: 'Over the course of the last several months, I’ve been busy building out my website utilizing Jekyll instead of Wordpress. It’s not my first time moving away from Wordpress, but I think it will end up being permanent.'
---
