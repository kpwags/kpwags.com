...
date: '2014-04-01'
description: 'Starting to run longer distances'
tags: [{ name: 'Goals', url: 'goals' }, { name: 'Fitness', url: 'fitness' }, { name: 'Running', url: 'running' }]
excerpt: "Well, it's official, this November I will be running my first full marathon. On November 23, 2014 I will be running the Philadelphia Marathon."
---
...
<PostImage
    src="/images/posts/2014-04-01-run-forest-run/run-forest-run.jpg"
    alt="Me running the Phillies 5k"
    width={640}
    height={640}
    centered
    shadowed
