...
date: '2014-01-14'
description: 'Looking back at a fun weekend in NYC'
tags: [{ name: 'Life', url: 'life' }, { name: 'Travel', url: 'travel' }]
excerpt: "This past weekend, Lauren and I went to New York City. It wasn't the best weather for the trip, but overall I feel we lucked out as we only needed umbrellas twice. Most of the time it was just gray or misting which isn't too bad in the grand scheme of things."
---
...
<PostImage
    src="/images/posts/2014-01-14-exploring-new-york-city/harvard-yale-faceoff.jpg"
    alt="The Harvard and Yale Hockey teams facing off in Madison Square Garden"
    width={1920}
    height={1080}
    centered
    shadowed={false}
...
<PostImage
    src="/images/posts/2014-01-14-exploring-new-york-city/trex.jpg"
    alt="Skeleton of a Tyrannosarus Rex at the Museum of Natural History"
    width={1920}
    height={1080}
    centered
    shadowed={false}
