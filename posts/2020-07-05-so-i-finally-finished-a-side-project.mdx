...
date: '2020-07-05'
description: 'I finally finished a side project to release into the wild.'
tags:
    [
        { name: 'Development', url: 'development' },
        { name: '.NET', url: 'dotnet' },
        { name: 'Where Do You Want to Eat?', url: 'where-do-you-want-to-eat' },
    ]
excerpt: 'I’ve often seen a joke going around dev circles talking about how developers have tons of half-finished side projects lying around. And as much as it pains me to say, I’m one of them. But now I can say that that pile has decreased by one.'
---
...
<PostImage
    src="/images/posts/2020-07-05-so-i-finally-finished-a-side-project/wheredoyouwanttoeat2.jpg"
    alt="Screen shot of the new Where Do You Want to Eat"
    width={1199}
    height={670}
    shadowed
    centered
...
<PostImage
    src="/images/posts/2020-07-05-so-i-finally-finished-a-side-project/where-do-you-want-to-eat.jpg"
    alt="Screen shot of the original Where Do You Want to Eat"
    width={1600}
    height={1000}
    shadowed
    centered
