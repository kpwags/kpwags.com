...
date: '2020-08-04'
description: 'Four months into the COVID-19 Pandemic, I finally broke down and built a gym in my basement.'
tags: [{ name: 'Fitness', url: 'fitness' }, { name: 'Strength Training', url: 'strength-training' }]
excerpt: 'Four months into the COVID-19 Pandemic, I finally broke down and built a gym in my basement.'
---
...
<PostImage
    src="/images/posts/2020-08-04-so-i-finally-built-a-home-gym/homegym.jpg"
    alt="My Home Gym Setup"
    width={1140}
    height={1920}
    shadowed
    centered
