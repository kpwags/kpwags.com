...
date: '2020-01-21'
description: 'Using spreadsheets to track my fitness goals and journey'
tags: [{ name: 'Fitness', url: 'fitness' }, { name: 'Strength Training', url: 'strength-training' }, { name: 'Running', url: 'running' }]
excerpt: 'One of the things I’ve been trying to do while getting in shape is tracking my progress. Weight is obviously one of the metrics I track, but it’s not the only one.'
---
...
<PostImage
    src="/images/posts/2020-01-21-tracking-my-fitness-journey/diet-log.png"
    alt="My Excel Spreadsheet Tracking My Diet"
    width={1073}
    height={764}
    centered
    shadowed
...
<PostImage
    src="/images/posts/2020-01-21-tracking-my-fitness-journey/lifting-notebook.jpg"
    alt="My Moleskine Notebook for Tracking My Lifts"
    width={1920}
    height={1440}
    centered
    shadowed
...
<PostImage
    src="/images/posts/2020-01-21-tracking-my-fitness-journey/lifting-log.png"
    alt="My Excel Spreadsheet Tracking My Lifts"
    width={1417}
    height={781}
    centered
    shadowed
...
<PostImage
    src="/images/posts/2020-01-21-tracking-my-fitness-journey/activity-log.png"
    alt="My Excel Spreadsheet Tracking My Activity"
    width={1805}
    height={431}
    centered
    shadowed
