...
date: '2021-02-10'
description: "Over the course of the last couple weeks, I've made some small improvements to my site. None of them are particularly huge, but I like the end result."
tags: [{ name: 'Development', url: 'development' }, { name: 'Blogging', url: 'blogging' }]
excerpt: "Over the course of the last couple weeks, I've made some small improvements to my site. None of them are particularly huge, but I like the end result."
---
